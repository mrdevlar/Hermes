...
The cumulative hazard, provides the amount of times we would expect to observe our well-defined event over a given period of time, assuming that event were repeatable. 
