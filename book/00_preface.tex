...
The current evolution of predictive maintenance strategies has been relatively uneven. The increased ability of organizations to capture a wider breadth and greater volume of data has lead to a narrowing of scope. 


This thesis addresses the development of predictive maintenance systems in informationally sparse systems, specifically using the photovoltaic inverters as a point of reference. It seeks to fill the void in the current literature on predictive maintenance in environments where there is limited access to operational data. It addresses the problem through the use of Bayesian time-to-event analysis, a statistical modeling approach used to estimate the remaining lifetime of an object. Finally, it presents an application using simulated data using Stan, the probabilistic programming language.
