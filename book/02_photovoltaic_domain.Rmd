...
The preconditions for the development of a predictive maintenance process differ depending on the domain and selected use cases. Yet, there is a common core of needs including implementation, data quality and sourcing. 
...
<!-- 
Abundance can offset the effect of noisy observations, but only to a degree. 
-->
