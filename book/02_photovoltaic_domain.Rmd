...
Inverter reliability is essential for ensuring steady output of a solar system. When an inverter fails, it disables all photovoltaic cells upstream of it. This makes it the single largest source of productivity loss in a solar system. 
...
\cite{Golnas2013}
Since the incapacitation of an inverter knocks out all the PV modules connected upstream of it, it comes as no surprise that inverter failure are the biggest cause of lost productivity in PV systems as well.
