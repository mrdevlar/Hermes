...
The purpose of this section is to lay out the simulated data set used throughout the remainder of the text. The data set uses the basic designs of a real-world photovoltaic system, but lacks the faults generated by poor company data management.

The data set is meant to simulate a real-world photovoltaic system, but one without many of the current issues. 
