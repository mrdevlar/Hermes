...
This parameterization defines a shape $\alpha$ and a scale $\sigma$ parameter and is equivalent to the rate $\lambda$ in the earlier form as being defined inversely, as an interval or scale, $\lambda = \left (\frac{1}{\sigma}  \right )^\alpha$.
