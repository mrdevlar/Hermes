...
<!--
The C-Index should be applied to a hold-out sample using the last n 
 -->
...
In a real-world setting where all variables are prone to measurement error, this can result in a 


 -->


In summary, there are some general guidelines for time-to-event modeling in a predictive context.
