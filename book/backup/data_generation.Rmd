...
Data is generated using inverse transform sampling using an empirical distribution function. That distribution is generated using input from two real-world data sets from photovoltaic companies. 

Data is generated using a life table like those found in classic demographic research. 

There are several reasons for this approach. First, it introduces time discretization which is a consideration in any real data set. This is in contrast to the model itself, which treats time as a continuous phenomena. 
