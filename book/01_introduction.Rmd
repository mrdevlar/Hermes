...
This thesis will address the development of a predictive maintenance system in informationally sparse domains. In so doing it will hope to fill the void in the current literature on predictive maintenance in areas of limited access to operational data. 
