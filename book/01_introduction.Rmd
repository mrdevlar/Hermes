...
While great effort is undertaken to be accessible, a certain degree of mathematical development is required to understand this text. Recommended is an understanding of the calculus of probabilities at the level of Blitzstein and Huang\cite{Blitzstein2014} as well as a first course on Bayesian linear models at the level of McElreath\cite{McElreath2016}. 

<!-- As the reader will notice, there is a tonal shift between the domain chapter and the remainder of the text. This is intentional. The first is meant to serve as a declarative explanation of the state of the world. The methodology and analysis make use of personal language and the "royal we" to better engage the reader in the mechanics of the process\cite{Urquhart2009}. -->
