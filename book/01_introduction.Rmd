...
To ensure that rigor is still found within the text, an extensive list of references and resources are made available in each chapter. These resources  that elucidate many of the technical aspects of the modeling process that are beyond the scope of this text.
