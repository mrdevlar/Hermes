...
To ensure that some rigor is retained, an extensive list of references and resources are made available in each chapter, dubbed "Extended Reading". These resources elucidate many of the technical aspects of the modeling process that are beyond the scope of this text.
