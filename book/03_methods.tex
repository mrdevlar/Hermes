...
% As we can see this likelihood is incredibly complex. Yet, the Gamma Frailty is one of the few that is capable of being fit in this manner, as it has a closed form solution for the log likelihood. Yet, there is another way this can be done without explicitly deriving the log likelihood. Specifically, this involves treating the 
