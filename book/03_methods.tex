...
% As we can see this likelihood is incredibly complex. Yet, the Gamma Frailty is one of the few that is capable of being fit in this manner, as it is one of the few distribution that has a closed form solution for the log likelihood. If 
